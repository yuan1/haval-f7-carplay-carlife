...
SOCK=/alt mount -Tio-pkt -o verbose=0,path=/dev/io-usb/io-usb-dcd,iface_num=1,protocol=ncm,npkt=10,usbdnet_mac=000022446688,mac=020022446688,name=${CARPLAY_IFACE_NAME} devnp-usbdnet.so
